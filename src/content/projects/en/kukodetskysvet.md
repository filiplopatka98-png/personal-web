...
kind: "Custom-built site · own PHP backend"
year: "2026"
...
It includes a booking system for children's birthday parties (3 packages), a custom content management system for the owner to edit content, and an email pipeline via PHPMailer + SMTP for confirmations and cron-scheduled reminders. Booking flow: form → pending row in the database → admin approval → emails to both customer and admin → a reminder before the event.
